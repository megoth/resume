...
% (c) 2012 Arne Hassel <arne.hassel@gmail.com> http://icanhasweb.net/
%
...
Har en master i informatikk fra Universitetet i Oslo. Erfaren programmerer, løsningsorientert og setter meg raskt inn i ny teknologi og nye programmeringsspråk.
Jeg behersker nettbaserte teknologier best, med fokus på JavaScript.
\end{minipage}
...
\begin{itemize}
\item
	\ressubheading{Questback AS}{Oslo}{Front-end utvikler}{2014 - nåværende}
	\begin{itemize}
		\item Ansvarlig for front-end utviklingen av Essentials, Questback DIY-løsning. Teknologier mye brukt er Angular, Grunt, Knockout, og jQuery.
	\end{itemize}
\item
	\ressubheading{Senter for pasientmedvirkning og samhandlingsforskning}{Oslo}{Systemutvikler}{2008 - 2014}
	\begin{itemize}
		\item Jobbet for det meste med frontend (HTML, CSS og JavaScript), men også noe backend (.NET-plattformen, C#, NHibernate)
	\end{itemize}
\item
...
\begin{itemize}
\item {\bf Utvikling:} {\bf (Veldig god:)} JavaScript, CSS, HTML, LESS, Sass, SQL, {\bf (God:)} C\#, Java, PHP, Python, RDF, SPARQL, TTL, XML, XSLT, {\bf (Grei:)} Assembly, C
\item {\bf Rammeverk:} Angular, Aurelia, React, Compass, .NET MVC 2-5, Umbraco, Wordpress, Web Forms
...
\begin{itemize}
\item {\bf Holder de ord admin interface:} Eksperiment for å la analytikerne i Holder de ord arbeide med løfter og forslag fra partiene på en ny måte. Utviklet med Aurelia. \url{https://github.com/megoth/hdo-aurelia} 
...
\begin{itemize}
\item
	\ressubheading{Holder de ord (HDO)}{Oslo}{Programmerer}{2012 - nåværende}
	\begin{itemize}
		\resitem{Vært med fra og til siden 2012, vært med på en del mindre prosjekter og eksperimenter.} 
	\end{itemize}
	\ressubheading{Kodeklubben Oslo}{Oslo}{Kodeveileder}{2016 - nåværende}
	\begin{itemize}
		\resitem{Kodeklubben Oslo er en del av Lær Kidsa Koding}
		\resitem{Har vært kodeveileder for barn i alderen 8-14 år i kurs hvor vi lærer dem programmeringsspråket Scratch} 
	\end{itemize}
