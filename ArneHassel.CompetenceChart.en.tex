...
\skilltable{Framework}{%
	\skill{AngularJS 1}{8}{10}
	\skill{Angular 2}{4}{10}
	\skill{Aurelia}{5}{8}
	\skill{Compass}{4}{7}
	\skill{jQuery}{8}{10}
	\skill{.NET MVC}{4}{7}
...
\skilltable{IDEs}{%
	\skill{JetBrains}{5}{7}
	\skill{Sublime}{6}{6}
	\skill{Visual Studio}{8}{9}
	\skill{Visual Studio Code}{7}{10}
}% 
\end{tabular*}
